...
class mysqltStatement
{
	...
	function mysqltStatement( $sql, &$connection )
	{
	...
	function &do_query()
	{
		...
		$resultId = @mysql_query( $this->sql, $this->connection );
		...
		$recordset = new mysqltResultSet( $resultId, $this->connection );
...
class mysqltResultSet
{
	...
	function mysqltResultSet( $resultId, $connectionId )
	{
		$this->fields = array();
