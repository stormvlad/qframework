...
class msqlStatement
{
	...
	function msqlStatement( $sql, &$connection )
	{
	...
	function &do_query()
	{
		...
		$recordset = new msqlResultSet( $resultId, $this->connection );
...
class msqlResultSet
{
	...
	function msqlResultSet( $resultId, $connectionId )
	{
		$this->fields = array();
	...
	{
		$this->_numOfRows = msql_num_rows( $this->resultId );
