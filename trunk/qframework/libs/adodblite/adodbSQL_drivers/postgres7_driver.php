...
class postgres7Statement
{
	...
	function postgres7Statement( $sql, &$connection )
	{
	...
	function &do_query()
	{
		...
		$recordset = new postgres7ResultSet( $resultId, $this->connection );
...
class postgres7ResultSet
{
	...
	function postgres7ResultSet( $resultId, $connectionId )
	{
		$this->fields = array();
