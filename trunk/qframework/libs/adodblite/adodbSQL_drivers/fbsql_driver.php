...
class fbsqlStatement
{
	...
	function fbsqlStatement( $sql, &$connection )
	{
	...
	function &do_query()
	{
		...
		$resultId = @fbsql_query( $this->sql . ";", $this->connection );
		...
		$recordset = new fbsqlResultSet( $resultId, $this->connection );
...
class fbsqlResultSet
{
	...
	function fbsqlResultSet( $resultId, $connectionId )
	{
		$this->fields = array();
	...
	{
		$this->_numOfRows = fbsql_num_rows( $this->resultId );
