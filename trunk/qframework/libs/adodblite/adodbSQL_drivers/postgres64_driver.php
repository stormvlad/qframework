...
class postgres64Statement
{
	...
	function postgres64Statement( $sql, &$connection )
	{
	...
	function &do_query()
	{
		...
		$recordset = new postgres64ResultSet( $resultId, $this->connection );
...
class postgres64ResultSet
{
	...
	function postgres64ResultSet( $resultId, $connectionId )
	{
		$this->fields = array();
	...
	{
		$this->_numOfRows = pg_num_rows( $this->resultId );
