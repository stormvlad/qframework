...
class maxdbStatement
{
	...
	function maxdbStatement( $sql, &$connection )
	{
	...
	function &do_query()
	{
		...
		$resultId = @maxdb_query( $this->sql, $this->connection );
		...
		$recordset = new maxdbResultSet( $resultId, $this->connection );
...
class maxdbResultSet
{
	...
	function maxdbResultSet( $resultId, $connectionId )
	{
		$this->fields = array();
	...
	{
		$this->_numOfRows = maxdb_num_rows( $this->resultId );
