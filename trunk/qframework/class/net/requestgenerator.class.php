<?php
    ...
    class RequestGenerator extends Object {
        ...
        {
            throw(new Exception("RequestGenerator::getBaseUrl: This function must be implemented by child classes."));
            die();
        }

        function getIndexUrl($abs = DEFAULT_ABSOLUTE_URL)
        {
            throw(new Exception("RequestGenerator::getIndexUrl: This function must be implemented by child classes."));
            die();
        }
        ...
        function getRequest()
        {
            throw(new Exception("RequestGenerator::getRequest: This function must be implemented by child classes."));
            die();
        }
