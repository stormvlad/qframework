<?php
    ...
    include_once("qframework/class/database/qdbparams.class.php" );

    /**
     * Provides a singleton for accessing the db.
     */
    class qMysqlDb extends qDb
    {
        function qMysqlDb()
        {
            $this->qDb();
        ...
        function &_getDb($dbParams)
        {
            ...
            if (!isset($db))
            {
                ...
                {
                    throw(new qException("MysqlDb::_getDb: Could not connect to the database!"));
                    die();
                }
