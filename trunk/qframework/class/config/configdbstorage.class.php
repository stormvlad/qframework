<?php
    ...
    include_once("framework/class/config/configabstractstorage.class.php");
    ...
    class ConfigDbStorage extends ConfigAbstractStorage {
         ...
         *
         */
        function ConfigDbStorage(&$db, $tableName)
        {
            $this->ConfigAbstractStorage();
        ...
        function reload()
        {
            ...
            if (!$result)
            {
                throw(new Exception("ConfigDbStorage::_loadData: There was an error loading the configuration data from the database. And this is bad ..."));
                die();
            }
        ...
        function _updateValue($key, $value)
        {
            ...
            switch ($type)
            {
                 ...
                 default:
                     throw( new Exception( "ConfigDbStorage::_updateValue: _getType produced an unexpected value of $type when checking value \"$value\""));
                    die();
             }
        ...
        function _insertValue($key, $value)
        {
            ...
            switch ($type)
            {
                ...
                default:
                    throw(new Exception("ConfigDbStorage::_insertValue: _getType produced an unexpected value of $type"));
                    die();
             }
