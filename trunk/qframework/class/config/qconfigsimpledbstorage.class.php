<?php
    ...
    include_once(QFRAMEWORK_CLASS_PATH . "qframework/class/config/qconfigdbstorage.class.php");
     ...
     * </ul>
     */
    class qConfigSimpleDbStorage extends qConfigDbStorage
    {
        /**
         * Connects to the database using the parameters in the config file.
         *
         */
        function qConfigSimpleDbStorage(&$db, $tableName)
        {
            $this->qConfigDbStorage($db, $tableName);
        }
