...
{
	$dsn = $_POST['databasetype'] . "://" . $_POST['dbusername'] . ":" . $_POST['dbpassword'] . "@" . $_POST['dbhost'] . "/" . $_POST['databasename'] . "#" . $_POST['transactions'] . $_POST['extend'] . "pear";
...
{
	$db = ADONewConnection($_POST['databasetype'], $_POST['transactions'] . $_POST['extend'] . "pear");
...
?>
  <tr>
    <td width="50%" valign="top"><p class="style2">Retrieve Associative Array. Tests $db->GetAssoc().</p>
    <p class="style3"><span class="style4">&lt;?</span><br>
