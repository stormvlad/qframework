...
class sybaseStatement
{
	...
	function sybaseStatement( $sql, &$connection )
	{
	...
	function &do_query()
	{
		...
		$resultId = @sybase_query( $this->sql, $this->connection );
		...
		$recordset = new sybaseResultSet( $resultId, $this->connection );
...
class sybaseResultSet
{
	...
	function sybaseResultSet( $resultId, $connectionId )
	{
		$this->fields = array();
	...
	{
		$this->_numOfRows = sybase_num_rows( $this->resultId );
