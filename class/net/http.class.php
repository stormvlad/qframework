<?php
    ...
    include_once("framework/class/net/httpgetvars.class.php");
    include_once("framework/class/net/httppostvars.class.php");
    include_once("framework/class/net/httpsessionvars.class.php");
    include_once("framework/class/net/httpcookievars.class.php");
    include_once("framework/class/net/httpfilesvars.class.php");
    include_once("framework/class/net/httpservervars.class.php");
    include_once("framework/class/net/httprequestvars.class.php");
    ...
    class Http extends Object {
        ...
        function &getGetVars()
        {
            ...
            {
                $getVarsInstance = new HttpGetVars(Http::getGet());
            }
        ...
        function &getPostVars()
        {
            ...
            {
                $postVarsInstance = new HttpPostVars(Http::getPost());
            }
        ...
        function &getSessionVars()
        {
            ...
            {
                $sessionVarsInstance = new HttpSessionVars(Http::getSession());
            }
        ...
        function &getCookieVars()
        {
            ...
            {
                $cookieVarsInstance = new HttpCookieVars(Http::getCookie());
            }
        ...
        function &getRequestVars()
        {
            ...
            {
                $requestVarsInstance = new HttpRequestVars(Http::getRequest());
            }
        ...
        function &getServerVars()
        {
            ...
            {
                $serverVarsInstance = new HttpServerVars(Http::getServer());
            }
        ...
        function &getFilesVars()
        {
            ...
            {
                $filesVarsInstance = new HttpFilesVars(Http::getFiles());
            }
